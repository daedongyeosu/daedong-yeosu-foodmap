...
function resetInstalledAppLaunch(launchParams = null) {
  ...
  if (reconcileInstalledAppQrEntry(launchParams?.targetURL || '')) return;
...
const YEOSU_LIFE_NEWS = [
  ...
  {
    id: 'island-ferry-half', category: '교통', icon: '⛴️', period: '9월~12월 · 예산 소진 시까지',
    title: '섬박람회 기간 타지역민 여객선 운임 반값',
    summary: '여수 관내 대상 항로를 이용하는 타지역민의 여객·도선 운임 50%를 지원합니다.',
    detail: '2026년 9월부터 12월까지 예산 소진 시까지 시행합니다. 여객 운임만 지원하며 차량 운임, 유류할증료와 터미널 이용료는 제외됩니다. 일부 항로와 선박은 지원 대상에서 제외됩니다.',
    warning: '예매 전에 공식 안내에서 대상 항로·선박과 남은 예산을 반드시 확인하세요.',
    source: '여수시 관광문화', verified: '2026.09.04 확인',
    url: 'https://www.yeosu.go.kr/tour/information/news/tour_news?idx=15859&mode=view', featured: true
  },
  {
    id: 'island-lodging-discount', category: '혜택', icon: '🏨', period: '4월~12월 · 예산 소진 시까지',
    title: '남도 숙박할인 BIG 이벤트',
    summary: '전남광주 외 주소지 관광객은 JG TOUR 참여 여수 숙박업소에서 조건별 할인을 받을 수 있습니다.',
    detail: '숙박 결제금액에 따라 2만~4만 원을 할인하며, 2026여수세계섬박람회 기간인 9월 5일부터 11월 4일까지는 1만 원을 추가 할인합니다. 관광객당 월 1회, 최대 3박까지 신청할 수 있습니다.',
    warning: '입장권 소지자 혜택이 아닙니다. JG TOUR 앱에서 주소지 확인 후 쿠폰을 발급받아야 하며, 참여 업소와 예산 잔여 여부를 예약 전에 확인하세요.',
    source: '여수시 관광문화', verified: '2026.09.04 확인',
