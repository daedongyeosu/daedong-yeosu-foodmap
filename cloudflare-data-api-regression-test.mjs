...
assert.equal(api.baseUrl, 'https://daedong-yeosu-data-api.sisakim.workers.dev');
...
assert.equal(calls[0].init.headers['X-Daedong-Client'], 'daedong-production-web-v1-20260807');
...
assert.equal(alienPhotoFiles.length, 54, 'representative photo and all 53 menu photos must remain in the production bundle');
...
console.log('PASS Cloudflare production API client contract');
