...
가게별 전용 QR과 배너 링크는 `?hero=가게ID` 형식을 사용한다. 이 링크로 처음 들어오면 해당 가게 상세를 한 번 즉시 열고, 상세를 닫으면 같은 가게의 전용 배너 화면을 유지한다. `?store=가게ID` 형식의 기존 공유 링크도 같은 방식으로 호환한다. QR은 운영 주소를 담는다.
...
| 향미진짬뽕 여서점 | <https://daedongmap.com/?hero=91622c10687d56dd> | <https://preview.daedongmap.com/?hero=91622c10687d56dd> | `assets/qr/hyangmijin-jjamppong-yeoseo.svg` |
