 ...
 fxRc3Script.onload=()=>{
  ...
  fxRc4Script.onload=()=>{
   ...
   fxRc5Script.onload=()=>{
    ...
    script.onload=()=>{
     const addressScript=document.createElement('script');addressScript.src='rc7-address-map.js?v=address-home-return-1-coarse-region-1-inapp-location-recovery-1';
