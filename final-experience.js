...
fxRc2Script.onload=()=>{
 ...
 fxRc3Script.onload=()=>{
  ...
  fxRc4Script.onload=()=>{
   ...
   fxRc5Script.onload=()=>{
    const css=document.createElement('link');css.rel='stylesheet';css.href='rc6-fixes.css?v=location-store-hero-1-handsu-copy-spacing-1-hero-clean-controls-1-hero-order-footer-2-dense-mobile-labels-1';document.head.append(css);
