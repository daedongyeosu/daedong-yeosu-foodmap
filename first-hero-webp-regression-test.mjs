...
assert.match(html, /<img class="brand-logo" src="assets\/brand\/yeosu-taste-map-logo\.png\?v=yeosu-taste-map-20260924-1" alt="여수맛지도">/,
  '첫 화면에는 캐시 버전이 지정된 여수맛지도 통합 로고를 사용해야 합니다.');
