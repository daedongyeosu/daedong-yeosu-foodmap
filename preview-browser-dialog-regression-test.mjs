...
assert.match(returnFlow, /sessionStorage\.setItem\('daedongMukkebiSummerEventSeenSessionV2', '1'\)/);
assert.match(returnFlow, /homeBootVisible: document\.documentElement\.classList\.contains\('daedong-external-return-pending'\)/);
assert.match(menuSearch, /sessionStorage\.setItem\('daedongMukkebiSummerEventSeenSessionV2', '1'\)/);
