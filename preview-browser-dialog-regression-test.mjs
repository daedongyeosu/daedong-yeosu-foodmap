...
assert.match(returnFlow, /sessionStorage\.setItem\('daedongMukkebiIslandExpoEventSeenSessionV1', '1'\)/);
assert.match(returnFlow, /homeBootVisible: document\.documentElement\.classList\.contains\('daedong-external-return-pending'\)/);
assert.match(menuSearch, /sessionStorage\.setItem\('daedongMukkebiIslandExpoEventSeenSessionV1', '1'\)/);
