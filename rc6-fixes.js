...
const rc6HeroDataPromise=Promise.all([fetchJson('data/store-coordinates.json',{}),fetchJson('data/banner-targets.json?v=notion-banner-15',{}),fetchJson('data/store-priority.json',{}),fetchJson('data/hero-campaigns.json?v=store-campaign-standard-1-dedicated-hero-14-plus-3-1',{campaigns:{},virtualStores:{}}),rc6LoadRainMode()]);
