...
const RC6_HERO_AUTOPLAY_MS=5500;
...
function rc6CampaignHeroEntries(){
 ...
 const campaignStoreHeroLimit=Math.max(1,Math.min(Number(campaign.storeHeroLimit)||RC6_CAMPAIGN_STORE_HERO_LIMIT,20));
...
function rc6RenderHero(){
 ...
 const previousHeroIndex=Number(heroCarousel?.logicalIndex?.()||0);rc6HeroRenderKey=renderKey;if(heroCarousel)heroCarousel.destroy();
...
const rc6HeroDataPromise=Promise.all([fetchJson('data/store-coordinates.json',{}),fetchJson('data/banner-targets.json?v=native-pages-1',{}),fetchJson('data/store-priority.json?v=former-managed-bottom-1-baeknyeon-ended-1-shared-referral-2',{}),fetchJson('data/hero-campaigns.json?v=store-campaign-standard-1-dedicated-hero-14-plus-3-1-auto-menu-fill-all-1-domino-munsu-14-1-ppongtteurak-14-1-all-photo-capacity-audit-1-bbq-menu-photos-14-1-four-store-qr-1-four-store-14-plus-3-1-teum-campaign-1-three-store-campaign-1-haeinine-campaign-1-pizzaschool-yeomun-1-hyangmijin-jjamppong-yeoseo-2-collected-shopinshop-1-managed-business-1-ajuker-munsu-14-1-shared102-menu-1-store-entry-status-20260913-all-store-dedicated-1',{campaigns:{},virtualStores:{}}),rc6LoadRainMode()]);
