...
const rc6HeroDataPromise=Promise.all([fetchJson('data/store-coordinates.json',{}),fetchJson('data/banner-targets.json?v=native-pages-1',{}),fetchJson('data/store-priority.json?v=former-managed-bottom-1-baeknyeon-ended-1-shared-referral-2',{}),fetchJson('data/hero-campaigns.json?v=store-campaign-standard-1-dedicated-hero-14-plus-3-1-auto-menu-fill-1-domino-munsu-14-1-ppongtteurak-14-1-all-photo-capacity-audit-1-bbq-menu-photos-14-1-four-store-qr-1-four-store-14-plus-3-1-teum-campaign-1-three-store-campaign-1-haeinine-campaign-1-pizzaschool-yeomun-1-hyangmijin-jjamppong-yeoseo-2-collected-shopinshop-1-managed-business-1',{campaigns:{},virtualStores:{}}),rc6LoadRainMode()]);
