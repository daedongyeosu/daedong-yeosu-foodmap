...
check(/href="app\.css\?v=final-integration-1"/.test(index),'정식 CSS 진입점 app.css');
check(/src="app\.js\?v=final-integration-1"/.test(index),'정식 JS 진입점 app.js');
...
check(app.includes('feeGuideMarkup(store, selectedRoute)')&&app.includes('feeGuideMount'),'동일 상세 팝업 저수수료 안내 구현');
...
check(css.includes('.topbar{display:grid'),'상단 여백·로고 위치 통합 CSS');
