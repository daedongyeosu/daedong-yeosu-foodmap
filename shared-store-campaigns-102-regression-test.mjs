...
assert.equal(hash(beforeSharedHero(hero)),production?'47df769a3ddfbb9b8605fb5e60f15cd4017f98279f323badecccb2cb3e109443':baseline.hero,'All non-target campaigns and virtual store records preserved');
