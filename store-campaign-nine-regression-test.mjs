...
assert.match(rc6, /hero-campaigns\.json\?v=store-campaign-nine-3/, 'The hero campaign data cache must be refreshed.');
assert.match(loader, /rc6-fixes\.js\?v=[^'\n]*store-campaign-nine-3/, 'The RC6 script cache must be refreshed.');
assert.match(index, /final-experience\.js\?v=[^"\n]*store-campaign-nine-3/, 'The final loader cache must be refreshed.');
