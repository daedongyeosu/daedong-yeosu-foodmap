...
// Only the approved destinations change; pin every original advertisement field.
...
assert.equal(hash(adKeys.map(key => ({...targets[key], notionUrl:legacyAdUrls[key]}))), '21ac623690772af84a5052fe04660132868f5c85290895a1710e486ff69c7615', 'Original advertisement content remains unchanged');
