...
assert.equal(hash({...hero,campaigns:Object.fromEntries(Object.entries(hero.campaigns).filter(([id])=>!ids.has(id)&&id!=='e66f136d0e468b6e'))}),'d5112951bebbdb466726a52268743d521d893492d3160678e6b199ded74bf80e');
